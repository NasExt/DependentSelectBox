...
class DependentSelectBoxExtension extends Nette\DI\CompilerExtension
{
	...
	{
		Nette\Forms\Container::extensionMethod('addDependentSelectBox', function (Nette\Forms\Container $container, string $name, string $label, $parents, callable $dependentCallback, bool $multiple = false) {
