...
class Container_a2540b89b4 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'productionMode' => true,
			'consoleMode' => true,
			'tempDir' => 'C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.93962461547869',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.93962461547869/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.93962461547869/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_a2540b89b4 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.93962461547869/cache/latte');
