...
class Container_b5af975e52 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'productionMode' => true,
			'consoleMode' => true,
			'tempDir' => 'C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.31815406010599',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.31815406010599/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.31815406010599/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_b5af975e52 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\easyweb\app\dependent-select-box\tests/tmp/0.31815406010599/cache/latte');
